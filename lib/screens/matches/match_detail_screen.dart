...
class _MatchDetailScreenState extends State<MatchDetailScreen> {
  ...
  Future<void> fetchData() async {
    try {
      ...
      final rate = (offer?['hourly_rate'] ?? 0).toDouble();
      final hours =
          (offer?['available_hours_per_day'] ?? 1).toDouble();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Deal Summary")),
      body: Padding(
        padding: const EdgeInsets.all(20),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text("Machine: ${data!['machine']}"),
