...
public class TelephonyStatsLog {
     ...
     * Usage: StatsLog.write(StatsLog.SATELLITE_ENTITLEMENT, int carrier_id, int result, int entitlement_status, boolean is_retry, int count, boolean is_allowed_service_entitlement, int[] entitlement_service_type, int entitlement_data_policy);<br>
     */
    ...
    // Values for SatelliteEntitlement.entitlement_data_policy
    public static final int SATELLITE_ENTITLEMENT__ENTITLEMENT_DATA_POLICY__SATELLITE_ENTITLEMENT_SERVICE_POLICY_UNKNOWN = 0;
    public static final int SATELLITE_ENTITLEMENT__ENTITLEMENT_DATA_POLICY__SATELLITE_ENTITLEMENT_SERVICE_POLICY_RESTRICTED = 1;
    public static final int SATELLITE_ENTITLEMENT__ENTITLEMENT_DATA_POLICY__SATELLITE_ENTITLEMENT_SERVICE_POLICY_CONSTRAINED = 2;
    public static final int SATELLITE_ENTITLEMENT__ENTITLEMENT_DATA_POLICY__SATELLITE_ENTITLEMENT_SERVICE_POLICY_SUPPORT_ALL = 3;
    ...
    public static final int SATELLITE_ACCESS_CONTROLLER__TRIGGERING_EVENT__TRIGGERING_EVENT_LOCATION_SETTINGS_DISABLED = 4;
    public static final int SATELLITE_ACCESS_CONTROLLER__TRIGGERING_EVENT__TRIGGERING_EVENT_CONFIG_DATA_UPDATED = 5;
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    public static StatsEvent buildStatsEvent(int code, int arg1, boolean arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int[] arg17, int arg18, long arg19, boolean arg20, boolean arg21) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeBoolean(arg2);
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, boolean arg4, int arg5, boolean arg6, int[] arg7, int arg8) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, boolean arg4, int arg5, int arg6, boolean arg7) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, boolean arg5, int arg6, boolean arg7, int arg8, int arg9, boolean arg10, boolean arg11, int arg12, boolean arg13, boolean arg14, boolean arg15, boolean arg16, boolean arg17, boolean arg18) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, int arg5, boolean arg6, boolean arg7, int arg8, boolean arg9, boolean arg10, int arg11, long arg12, int arg13, long arg14, int arg15, int arg16, int arg17, boolean arg18, boolean arg19, boolean arg20, boolean arg21, boolean arg22) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, boolean arg7, int arg8, boolean arg9, int arg10, boolean arg11, boolean arg12, int arg13, long arg14, int arg15, boolean arg16, boolean arg17, boolean arg18, boolean arg19) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, boolean arg9, boolean arg10, int arg11, boolean arg12) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int arg17, int arg18, int arg19, int arg20, int arg21, int arg22, int arg23, int arg24, int arg25, int arg26, int arg27, int arg28, boolean arg29, int arg30, int arg31, int arg32, int arg33, int arg34, int arg35, boolean arg36, int arg37, int arg38, int arg39, int arg40, int arg41, int arg42, int arg43) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
