...
public class FrameworkStatsLog {
    ...
    /**
     * ZramSetupExecuted zram_setup_executed<br>
     * Usage: StatsLog.write(StatsLog.ZRAM_SETUP_EXECUTED, int zram_setup_result, int comp_algorithm_setup_result, int writeback_setup_result, int recompression_setup_result, long zram_size_mb, long writeback_size_mb);<br>
     */
    public static final int ZRAM_SETUP_EXECUTED = 1029;

    /**
     * IntentRedirectBlocked intent_redirect_blocked<br>
     * Usage: StatsLog.write(StatsLog.INTENT_REDIRECT_BLOCKED, int creator_uid, int calling_uid, int reason);<br>
     */
    public static final int INTENT_REDIRECT_BLOCKED = 1037;

    /**
     * AndroidGraphicsBitmapAllocated android_graphics_bitmap_allocated<br>
     * Usage: StatsLog.write(StatsLog.ANDROID_GRAPHICS_BITMAP_ALLOCATED, int uid, int width, int height);<br>
     */
    public static final int ANDROID_GRAPHICS_BITMAP_ALLOCATED = 1039;

    /**
     * AdvancedProtectionStateChanged advanced_protection_state_changed<br>
     * Usage: StatsLog.write(StatsLog.ADVANCED_PROTECTION_STATE_CHANGED, boolean enabled, int hours_since_last_change, int last_dialog_feature_id, int last_dialogue_type, boolean last_dialog_learn_more_clicked, int last_dialog_hours_since_enabled);<br>
     */
    public static final int ADVANCED_PROTECTION_STATE_CHANGED = 1040;

    /**
     * AdvancedProtectionSupportDialogDisplayed advanced_protection_support_dialog_displayed<br>
     * Usage: StatsLog.write(StatsLog.ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED, int feature_id, int dialogue_type, boolean learn_more_clicked, int hours_since_enabled);<br>
     */
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED = 1041;

    /**
     * ExtraIntentKeysCollectedOnServer extra_intent_keys_collected_on_server<br>
     * Usage: StatsLog.write(StatsLog.EXTRA_INTENT_KEYS_COLLECTED_ON_SERVER, int creator_uid);<br>
     */
    public static final int EXTRA_INTENT_KEYS_COLLECTED_ON_SERVER = 1042;

    /**
     * ClipboardGetEventReported clipboard_get_event_reported<br>
     * Usage: StatsLog.write(StatsLog.CLIPBOARD_GET_EVENT_REPORTED, int source_uid, int target_uid, int target_process_state, int[] clip_data_type, int time_since_set_in_secs);<br>
     */
    public static final int CLIPBOARD_GET_EVENT_REPORTED = 1048;
    ...
    /**
     * AdvancedProtectionStateInfo advanced_protection_state_info<br>
     * Usage: StatsLog.write(StatsLog.ADVANCED_PROTECTION_STATE_INFO, boolean enabled, int hours_since_last_change);<br>
     */
    public static final int ADVANCED_PROTECTION_STATE_INFO = 10236;
    ...
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_EYE_TRACKING_COARSE = 156;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_EYE_TRACKING_FINE = 157;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_FACE_TRACKING = 158;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_HAND_TRACKING = 159;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_HEAD_TRACKING = 160;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_SCENE_UNDERSTANDING_COARSE = 161;
    public static final int FOREGROUND_SERVICE_APP_OP_SESSION_ENDED__APP_OP_NAME__APP_OP_SCENE_UNDERSTANDING_FINE = 162;
    ...
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_MOVE_WINDOW_TO_DISPLAY = 129;
    public static final int UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__STATUS_BAR_APP_RETURN_TO_CALL_CHIP = 130;
    ...
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_DESKTOP_MODE_ENTER_APP_HANDLE_MENU = 35;
    public static final int UIACTION_LATENCY_REPORTED__ACTION__ACTION_DESKTOP_MODE_EXIT_MODE = 36;
    ...
    public static final int CDM_ASSOCIATION_ACTION__DEVICE_PROFILE__DEVICE_PROFILE_VIRTUAL_DEVICE = 7;
    ...
    // Values for AutofillPresentationEventReported.fill_dialog_not_shown_reason
    public static final int AUTOFILL_PRESENTATION_EVENT_REPORTED__FILL_DIALOG_NOT_SHOWN_REASON__REASON_UNKNOWN = 0;
    public static final int AUTOFILL_PRESENTATION_EVENT_REPORTED__FILL_DIALOG_NOT_SHOWN_REASON__REASON_FILL_DIALOG_DISABLED = 1;
    public static final int AUTOFILL_PRESENTATION_EVENT_REPORTED__FILL_DIALOG_NOT_SHOWN_REASON__REASON_SCREEN_HAS_CREDMAN_FIELD = 2;
    public static final int AUTOFILL_PRESENTATION_EVENT_REPORTED__FILL_DIALOG_NOT_SHOWN_REASON__REASON_LAST_TRIGGERED_ID_CHANGED = 3;
    public static final int AUTOFILL_PRESENTATION_EVENT_REPORTED__FILL_DIALOG_NOT_SHOWN_REASON__REASON_WAIT_FOR_IME_ANIMATION = 4;
    public static final int AUTOFILL_PRESENTATION_EVENT_REPORTED__FILL_DIALOG_NOT_SHOWN_REASON__REASON_TIMEOUT_SINCE_IME_ANIMATED = 5;
    public static final int AUTOFILL_PRESENTATION_EVENT_REPORTED__FILL_DIALOG_NOT_SHOWN_REASON__REASON_DELAY_AFTER_ANIMATION_END = 6;
    public static final int AUTOFILL_PRESENTATION_EVENT_REPORTED__FILL_DIALOG_NOT_SHOWN_REASON__REASON_TIMEOUT_AFTER_DELAY = 7;
    ...
    public static final int IME_REQUEST_FINISHED__REASON__REASON_IME_REQUESTED_CHANGED_LISTENER = 59;
    ...
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_WM_REQUESTED_VISIBLE_TYPES_NOT_CHANGED = 70;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_CLIENT_UPDATE_ANIMATING_TYPES = 71;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_WM_UPDATE_ANIMATING_TYPES = 72;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_WM_WINDOW_ANIMATING_TYPES_CHANGED = 73;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_WM_NOTIFY_HIDE_ANIMATION_FINISHED = 74;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_WM_UPDATE_DISPLAY_WINDOW_ANIMATING_TYPES = 75;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_CLIENT_ON_CONTROLS_CHANGED = 76;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_IME_INVOKER = 77;
    public static final int IME_REQUEST_FINISHED__PHASE__PHASE_SERVER_CLIENT_INVOKER = 78;
    ...
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_EYE_TRACKING_COARSE = 156;
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_EYE_TRACKING_FINE = 157;
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_FACE_TRACKING = 158;
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_HAND_TRACKING = 159;
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_HEAD_TRACKING = 160;
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_SCENE_UNDERSTANDING_COARSE = 161;
    public static final int APP_OP_ACCESS_TRACKED__OP_ID__APP_OP_SCENE_UNDERSTANDING_FINE = 162;
    ...
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_EYE_TRACKING_COARSE = 156;
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_EYE_TRACKING_FINE = 157;
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_FACE_TRACKING = 158;
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_HAND_TRACKING = 159;
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_HEAD_TRACKING = 160;
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_SCENE_UNDERSTANDING_COARSE = 161;
    public static final int APP_OP_NOTE_OP_OR_CHECK_OP_BINDER_API_CALLED__OP_ID__APP_OP_SCENE_UNDERSTANDING_FINE = 162;
    ...
    // Values for ZramSetupExecuted.zram_setup_result
    public static final int ZRAM_SETUP_EXECUTED__ZRAM_SETUP_RESULT__ZRAM_SETUP_UNSPECIFIED = 0;
    public static final int ZRAM_SETUP_EXECUTED__ZRAM_SETUP_RESULT__ZRAM_SETUP_SUCCESS = 1;
    public static final int ZRAM_SETUP_EXECUTED__ZRAM_SETUP_RESULT__ZRAM_SETUP_CHECK_STATUS = 2;
    public static final int ZRAM_SETUP_EXECUTED__ZRAM_SETUP_RESULT__ZRAM_SETUP_ACTIVATED = 3;
    public static final int ZRAM_SETUP_EXECUTED__ZRAM_SETUP_RESULT__ZRAM_SETUP_PARSE_SPEC = 4;
    public static final int ZRAM_SETUP_EXECUTED__ZRAM_SETUP_RESULT__ZRAM_SETUP_UPDATE_DISK_SIZE_FAIL = 5;
    public static final int ZRAM_SETUP_EXECUTED__ZRAM_SETUP_RESULT__ZRAM_SETUP_SWAP_ON_FAIL = 6;
    public static final int ZRAM_SETUP_EXECUTED__ZRAM_SETUP_RESULT__ZRAM_SETUP_MK_SWAP_FAIL = 7;

    // Values for ZramSetupExecuted.comp_algorithm_setup_result
    public static final int ZRAM_SETUP_EXECUTED__COMP_ALGORITHM_SETUP_RESULT__COMP_ALGORITHM_SETUP_UNSPECIFIED = 0;
    public static final int ZRAM_SETUP_EXECUTED__COMP_ALGORITHM_SETUP_RESULT__COMP_ALGORITHM_SETUP_SUCCESS = 1;
    public static final int ZRAM_SETUP_EXECUTED__COMP_ALGORITHM_SETUP_RESULT__COMP_ALGORITHM_SETUP_FAIL = 2;

    // Values for ZramSetupExecuted.writeback_setup_result
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_UNSPECIFIED = 0;
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_SUCCESS = 1;
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_CHECK_STATUS = 2;
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_NOT_SUPPORTED = 3;
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_ACTIVATED = 4;
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_PARSE_SPEC = 5;
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_DEVICE_SIZE_ZERO = 6;
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_SET_ACTUAL_DEVICE_SIZE_FAIL = 7;
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_CREATE_BACKING_FILE_FAIL = 8;
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_CREATE_BACKING_DEVICE_FAIL = 9;
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_SET_WRITEBACK_DEVICE_FAIL = 10;
    public static final int ZRAM_SETUP_EXECUTED__WRITEBACK_SETUP_RESULT__WRITEBACK_SETUP_WRITEBACK_LIMIT_ENABLE_FAIL = 11;

    // Values for ZramSetupExecuted.recompression_setup_result
    public static final int ZRAM_SETUP_EXECUTED__RECOMPRESSION_SETUP_RESULT__RECOMPRESSION_SETUP_UNSPECIFIED = 0;
    public static final int ZRAM_SETUP_EXECUTED__RECOMPRESSION_SETUP_RESULT__RECOMPRESSION_SETUP_SUCCESS = 1;
    public static final int ZRAM_SETUP_EXECUTED__RECOMPRESSION_SETUP_RESULT__RECOMPRESSION_SETUP_CHECK_STATUS = 2;
    public static final int ZRAM_SETUP_EXECUTED__RECOMPRESSION_SETUP_RESULT__RECOMPRESSION_SETUP_NOT_SUPPORTED = 3;
    public static final int ZRAM_SETUP_EXECUTED__RECOMPRESSION_SETUP_RESULT__RECOMPRESSION_SETUP_ACTIVATED = 4;
    public static final int ZRAM_SETUP_EXECUTED__RECOMPRESSION_SETUP_RESULT__RECOMPRESSION_SETUP_SET_RECOMP_ALGORITHM_FAIL = 5;

    // Values for IntentRedirectBlocked.reason
    public static final int INTENT_REDIRECT_BLOCKED__REASON__INTENT_REDIRECT_BLOCKED_UNSPECIFIED = 0;
    public static final int INTENT_REDIRECT_BLOCKED__REASON__INTENT_REDIRECT_EXCEPTION_MISSING_OR_INVALID_TOKEN = 1;
    public static final int INTENT_REDIRECT_BLOCKED__REASON__INTENT_REDIRECT_EXCEPTION_GRANT_URI_PERMISSION = 2;
    public static final int INTENT_REDIRECT_BLOCKED__REASON__INTENT_REDIRECT_EXCEPTION_START_ANY_ACTIVITY_PERMISSION = 3;
    public static final int INTENT_REDIRECT_BLOCKED__REASON__INTENT_REDIRECT_ABORT_START_ANY_ACTIVITY_PERMISSION = 4;
    public static final int INTENT_REDIRECT_BLOCKED__REASON__INTENT_REDIRECT_ABORT_INTENT_FIREWALL_START_ACTIVITY = 5;
    public static final int INTENT_REDIRECT_BLOCKED__REASON__INTENT_REDIRECT_ABORT_PERMISSION_POLICY_START_ACTIVITY = 6;

    // Values for AdvancedProtectionStateChanged.last_dialog_feature_id
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOG_FEATURE_ID__FEATURE_ID_UNKNOWN = 0;
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOG_FEATURE_ID__FEATURE_ID_DISALLOW_CELLULAR_2G = 1;
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOG_FEATURE_ID__FEATURE_ID_DISALLOW_INSTALL_UNKNOWN_SOURCES = 2;
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOG_FEATURE_ID__FEATURE_ID_DISALLOW_USB = 3;
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOG_FEATURE_ID__FEATURE_ID_DISALLOW_WEP = 4;
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOG_FEATURE_ID__FEATURE_ID_ENABLE_MTE = 5;

    // Values for AdvancedProtectionStateChanged.last_dialogue_type
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOGUE_TYPE__DIALOGUE_TYPE_UNKNOWN = 0;
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOGUE_TYPE__DIALOGUE_TYPE_BLOCKED_INTERACTION = 1;
    public static final int ADVANCED_PROTECTION_STATE_CHANGED__LAST_DIALOGUE_TYPE__DIALOGUE_TYPE_DISABLED_SETTING = 2;

    // Values for AdvancedProtectionSupportDialogDisplayed.feature_id
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__FEATURE_ID__FEATURE_ID_UNKNOWN = 0;
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__FEATURE_ID__FEATURE_ID_DISALLOW_CELLULAR_2G = 1;
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__FEATURE_ID__FEATURE_ID_DISALLOW_INSTALL_UNKNOWN_SOURCES = 2;
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__FEATURE_ID__FEATURE_ID_DISALLOW_USB = 3;
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__FEATURE_ID__FEATURE_ID_DISALLOW_WEP = 4;
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__FEATURE_ID__FEATURE_ID_ENABLE_MTE = 5;

    // Values for AdvancedProtectionSupportDialogDisplayed.dialogue_type
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__DIALOGUE_TYPE__DIALOGUE_TYPE_UNKNOWN = 0;
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__DIALOGUE_TYPE__DIALOGUE_TYPE_BLOCKED_INTERACTION = 1;
    public static final int ADVANCED_PROTECTION_SUPPORT_DIALOG_DISPLAYED__DIALOGUE_TYPE__DIALOGUE_TYPE_DISABLED_SETTING = 2;

    // Values for ClipboardGetEventReported.target_process_state
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_UNKNOWN_TO_PROTO = 998;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_UNKNOWN = 999;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_PERSISTENT = 1000;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_PERSISTENT_UI = 1001;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_TOP = 1002;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_FOREGROUND_SERVICE = 1003;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_BOUND_FOREGROUND_SERVICE = 1004;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_IMPORTANT_FOREGROUND = 1005;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_IMPORTANT_BACKGROUND = 1006;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_TRANSIENT_BACKGROUND = 1007;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_BACKUP = 1008;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_SERVICE = 1009;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_RECEIVER = 1010;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_TOP_SLEEPING = 1011;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_HEAVY_WEIGHT = 1012;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_HOME = 1013;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_LAST_ACTIVITY = 1014;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY = 1015;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_CACHED_ACTIVITY_CLIENT = 1016;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_CACHED_RECENT = 1017;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_CACHED_EMPTY = 1018;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_NONEXISTENT = 1019;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__TARGET_PROCESS_STATE__PROCESS_STATE_BOUND_TOP = 1020;

    // Values for ClipboardGetEventReported.clip_data_type
    public static final int CLIPBOARD_GET_EVENT_REPORTED__CLIP_DATA_TYPE__MIMETYPE_UNKNOWN = 0;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__CLIP_DATA_TYPE__MIMETYPE_TEXT_PLAIN = 1;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__CLIP_DATA_TYPE__MIMETYPE_TEXT_HTML = 2;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__CLIP_DATA_TYPE__MIMETYPE_TEXT_URILIST = 3;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__CLIP_DATA_TYPE__MIMETYPE_TEXT_INTENT = 4;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__CLIP_DATA_TYPE__MIMETYPE_APPLICATION_ACTIVITY = 5;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__CLIP_DATA_TYPE__MIMETYPE_APPLICATION_SHORTCUT = 6;
    public static final int CLIPBOARD_GET_EVENT_REPORTED__CLIP_DATA_TYPE__MIMETYPE_APPLICATION_TASK = 7;
    ...
    public static final int APP_OPS__OP_ID__APP_OP_EYE_TRACKING_COARSE = 156;
    public static final int APP_OPS__OP_ID__APP_OP_EYE_TRACKING_FINE = 157;
    public static final int APP_OPS__OP_ID__APP_OP_FACE_TRACKING = 158;
    public static final int APP_OPS__OP_ID__APP_OP_HAND_TRACKING = 159;
    public static final int APP_OPS__OP_ID__APP_OP_HEAD_TRACKING = 160;
    public static final int APP_OPS__OP_ID__APP_OP_SCENE_UNDERSTANDING_COARSE = 161;
    public static final int APP_OPS__OP_ID__APP_OP_SCENE_UNDERSTANDING_FINE = 162;
    ...
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_EYE_TRACKING_COARSE = 156;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_EYE_TRACKING_FINE = 157;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_FACE_TRACKING = 158;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_HAND_TRACKING = 159;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_HEAD_TRACKING = 160;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_SCENE_UNDERSTANDING_COARSE = 161;
    public static final int RUNTIME_APP_OP_ACCESS__OP__APP_OP_SCENE_UNDERSTANDING_FINE = 162;
    ...
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_EYE_TRACKING_COARSE = 156;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_EYE_TRACKING_FINE = 157;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_FACE_TRACKING = 158;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_HAND_TRACKING = 159;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_HEAD_TRACKING = 160;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_SCENE_UNDERSTANDING_COARSE = 161;
    public static final int ATTRIBUTED_APP_OPS__OP__APP_OP_SCENE_UNDERSTANDING_FINE = 162;
    ...
    public static void write(int code, boolean arg1, int arg2, int arg3, int arg4, boolean arg5, int arg6) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeBoolean(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1) {
        ...
        if (EXTRA_INTENT_KEYS_COLLECTED_ON_SERVER == code) {
            builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    public static void write(int code, int arg1, int arg2, boolean arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, boolean arg10, int[] arg11, int[] arg12, java.lang.String[] arg13, int[] arg14, java.lang.String arg15, int[] arg16, int[] arg17, int arg18, boolean arg19, int arg20, int arg21, int arg22, java.lang.String arg23) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    public static void write(int code, int arg1, int arg2, boolean arg3, int[] arg4, int[] arg5, int[] arg6, int[] arg7, boolean[] arg8, int[] arg9, int[] arg10, int[] arg11, int[] arg12, int[] arg13, int[] arg14, java.lang.String[] arg15, boolean arg16, java.lang.String[] arg17, int[] arg18, int arg19, boolean[] arg20, boolean arg21) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1, int arg2, int arg3) {
        ...
        if (INTENT_REDIRECT_BLOCKED == code) {
            builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        if (ANDROID_GRAPHICS_BITMAP_ALLOCATED == code) {
            builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        builder.writeInt(arg2);
        if (ISOLATED_UID_CHANGED == code) {
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, boolean arg12, int arg13, int arg14, int arg15, int arg16, int arg17, boolean arg18, boolean arg19, boolean arg20, int arg21, int arg22, long arg23, long arg24, int arg25, int arg26, int arg27, int arg28, int arg29, int arg30, boolean arg31, boolean arg32, long arg33, long arg34, int arg35, long arg36, long arg37, int arg38, int arg39, int arg40, int arg41, int arg42, int arg43, int arg44, int arg45, long arg46, int arg47, int arg48, int arg49, int arg50, int arg51, int arg52, long arg53, long arg54) {
        ...
        builder.writeLong(arg53);
        builder.writeLong(arg54);
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, long arg5, int arg6, java.lang.String[] arg7, int[] arg8, boolean arg9, int arg10, int arg11, boolean arg12) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, long arg5, long arg6) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int[] arg4, int arg5) {
        ...
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (CLIPBOARD_GET_EVENT_REPORTED == code) {
            builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        builder.writeInt(arg2);
        if (CLIPBOARD_GET_EVENT_REPORTED == code) {
    ...
    public static StatsEvent buildStatsEvent(int code, boolean arg1, int arg2) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeBoolean(arg1);
        builder.writeInt(arg2);
