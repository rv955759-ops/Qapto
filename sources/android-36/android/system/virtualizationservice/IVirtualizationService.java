...
public interface IVirtualizationService extends android.os.IInterface
{
  ...
  public static class Default implements android.system.virtualizationservice.IVirtualizationService
  {
     ...
     */
    @Override public void setEncryptedStorageSize(android.os.ParcelFileDescriptor imageFd, long size) throws android.os.RemoteException
    {
    }
    /**
  ...
  public static abstract class Stub extends android.os.Binder implements android.system.virtualizationservice.IVirtualizationService
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_setEncryptedStorageSize:
        {
          android.os.ParcelFileDescriptor _arg0;
          _arg0 = data.readTypedObject(android.os.ParcelFileDescriptor.CREATOR);
          long _arg1;
    ...
    private static class Proxy implements android.system.virtualizationservice.IVirtualizationService
    {
      ...
      @Override public void setEncryptedStorageSize(android.os.ParcelFileDescriptor imageFd, long size) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setEncryptedStorageSize, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
    ...
    static final int TRANSACTION_setEncryptedStorageSize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
    static final int TRANSACTION_createOrUpdateIdsigFile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
    static final int TRANSACTION_debugListVms = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
    static final int TRANSACTION_getAssignableDevices = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
    static final int TRANSACTION_getSupportedOSList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
    static final int TRANSACTION_getDebugPolicy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
    static final int TRANSACTION_isFeatureEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
    static final int TRANSACTION_enableTestAttestation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
    static final int TRANSACTION_isRemoteAttestationSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
    static final int TRANSACTION_isUpdatableVmSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
    static final int TRANSACTION_removeVmInstance = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
    static final int TRANSACTION_claimVmInstance = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
  }
  /** @hide */
   ...
   * The file must be open with both read and write permissions.
   */
  public void setEncryptedStorageSize(android.os.ParcelFileDescriptor imageFd, long size) throws android.os.RemoteException;
  /**
   * Create or update an idsig file that digests the given APK file. The idsig file follows the
   * idsig format that is defined by the APK Signature Scheme V4. The idsig file is not updated
   * when it is up to date with the input file, which is checked by comparing the
