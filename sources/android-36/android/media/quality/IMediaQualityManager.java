...
public interface IMediaQualityManager extends android.os.IInterface
{
  ...
  public static abstract class Stub extends android.os.Binder implements android.media.quality.IMediaQualityManager
  {
    ...
    static final int TRANSACTION_setDefaultPictureProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
    static final int TRANSACTION_getPictureProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
    static final int TRANSACTION_getPictureProfilesByPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
    static final int TRANSACTION_getAvailablePictureProfiles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
    static final int TRANSACTION_getPictureProfilePackageNames = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
    static final int TRANSACTION_getPictureProfileAllowList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
    static final int TRANSACTION_setPictureProfileAllowList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
    static final int TRANSACTION_getPictureProfileHandle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
    static final int TRANSACTION_getPictureProfileHandleValue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
    static final int TRANSACTION_getDefaultPictureProfileHandleValue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
    static final int TRANSACTION_notifyPictureProfileHandleSelection = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
    static final int TRANSACTION_getPictureProfileForTvInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
    static final int TRANSACTION_createSoundProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
    static final int TRANSACTION_updateSoundProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
    static final int TRANSACTION_removeSoundProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
    static final int TRANSACTION_setDefaultSoundProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
    static final int TRANSACTION_getSoundProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
    static final int TRANSACTION_getSoundProfilesByPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
    static final int TRANSACTION_getAvailableSoundProfiles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
    static final int TRANSACTION_getSoundProfilePackageNames = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
    static final int TRANSACTION_getSoundProfileAllowList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
    static final int TRANSACTION_setSoundProfileAllowList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
    static final int TRANSACTION_getSoundProfileHandle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
    static final int TRANSACTION_registerPictureProfileCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
    static final int TRANSACTION_registerSoundProfileCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
    static final int TRANSACTION_registerAmbientBacklightCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
    static final int TRANSACTION_registerActiveProcessingPictureListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
    static final int TRANSACTION_getParameterCapabilities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
    static final int TRANSACTION_isSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
    static final int TRANSACTION_setAutoPictureQualityEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
    static final int TRANSACTION_isAutoPictureQualityEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
    static final int TRANSACTION_setSuperResolutionEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
    static final int TRANSACTION_isSuperResolutionEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
    static final int TRANSACTION_setAutoSoundQualityEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
    static final int TRANSACTION_isAutoSoundQualityEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
    static final int TRANSACTION_setAmbientBacklightSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
    static final int TRANSACTION_setAmbientBacklightEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
    static final int TRANSACTION_isAmbientBacklightEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
  }
  /** @hide */
