...
public class PdfStatsLog {
    ...
    /**
     * PhotopickerAppMediaCapabilitiesReported photopicker_app_media_capabilities_reported<br>
     * Usage: StatsLog.write(StatsLog.PHOTOPICKER_APP_MEDIA_CAPABILITIES_REPORTED, int session_id, int[] supported_hdr_types, int[] unsupported_hdr_types);<br>
     */
    public static final int PHOTOPICKER_APP_MEDIA_CAPABILITIES_REPORTED = 1043;

    /**
     * PhotopickerVideoTranscodingDetailsLogged photopicker_video_transcoding_details_logged<br>
     * Usage: StatsLog.write(StatsLog.PHOTOPICKER_VIDEO_TRANSCODING_DETAILS_LOGGED, int session_id, int duration, int colorStandard, int colorTransfer, int mimeType);<br>
     */
    public static final int PHOTOPICKER_VIDEO_TRANSCODING_DETAILS_LOGGED = 1044;
    ...
    public static final int PHOTOPICKER_UIEVENT_LOGGED__UI_EVENT__PICKER_TRANSCODING_STARTED = 45;
    public static final int PHOTOPICKER_UIEVENT_LOGGED__UI_EVENT__PICKER_TRANSCODING_FINISHED = 46;
    public static final int PHOTOPICKER_UIEVENT_LOGGED__UI_EVENT__PICKER_TRANSCODING_FAILED = 47;
    ...
    // Values for PhotopickerAppMediaCapabilitiesReported.supported_hdr_types
    public static final int PHOTOPICKER_APP_MEDIA_CAPABILITIES_REPORTED__SUPPORTED_HDR_TYPES__TYPE_UNSPECIFIED = 0;
    public static final int PHOTOPICKER_APP_MEDIA_CAPABILITIES_REPORTED__SUPPORTED_HDR_TYPES__TYPE_DOLBY_VISION = 1;
    public static final int PHOTOPICKER_APP_MEDIA_CAPABILITIES_REPORTED__SUPPORTED_HDR_TYPES__TYPE_HDR10 = 2;
    public static final int PHOTOPICKER_APP_MEDIA_CAPABILITIES_REPORTED__SUPPORTED_HDR_TYPES__TYPE_HDR10_PLUS = 3;
    public static final int PHOTOPICKER_APP_MEDIA_CAPABILITIES_REPORTED__SUPPORTED_HDR_TYPES__TYPE_HLG = 4;

    // Values for PhotopickerAppMediaCapabilitiesReported.unsupported_hdr_types
    public static final int PHOTOPICKER_APP_MEDIA_CAPABILITIES_REPORTED__UNSUPPORTED_HDR_TYPES__TYPE_UNSPECIFIED = 0;
    public static final int PHOTOPICKER_APP_MEDIA_CAPABILITIES_REPORTED__UNSUPPORTED_HDR_TYPES__TYPE_DOLBY_VISION = 1;
    public static final int PHOTOPICKER_APP_MEDIA_CAPABILITIES_REPORTED__UNSUPPORTED_HDR_TYPES__TYPE_HDR10 = 2;
    public static final int PHOTOPICKER_APP_MEDIA_CAPABILITIES_REPORTED__UNSUPPORTED_HDR_TYPES__TYPE_HDR10_PLUS = 3;
    public static final int PHOTOPICKER_APP_MEDIA_CAPABILITIES_REPORTED__UNSUPPORTED_HDR_TYPES__TYPE_HLG = 4;

    // Values for PhotopickerVideoTranscodingDetailsLogged.mimeType
    public static final int PHOTOPICKER_VIDEO_TRANSCODING_DETAILS_LOGGED__MIME_TYPE__MIME_UNSPECIFIED = 0;
    public static final int PHOTOPICKER_VIDEO_TRANSCODING_DETAILS_LOGGED__MIME_TYPE__MIME_DOLBY = 1;
    public static final int PHOTOPICKER_VIDEO_TRANSCODING_DETAILS_LOGGED__MIME_TYPE__MIME_HEVC = 2;
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, boolean arg8, boolean arg9, boolean arg10, boolean arg11, boolean arg12, boolean arg13, boolean arg14) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
